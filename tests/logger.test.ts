...
describe("Logger", () => {
  ...
  describe("group logging", () => {
    ...
    it("should support console.group when available", () => {
      ...
      expect(mockGroupCollapsed).toHaveBeenCalledWith(
        "Console Collapsed Group"
      );
      expect(mockGroupEnd).toHaveBeenCalled();
    });
  });
  ...
  describe("JSON logging error handling", () => {
    it("should handle JSON serialization errors", () => {
      ...
      const originalStringify = require("safe-stable-stringify");
      jest.doMock("safe-stable-stringify", () => {
        return jest.fn(() => {
      ...
      consoleLogSpy.mockRestore();
      jest.doMock("safe-stable-stringify", () => originalStringify);
    });
  });
  ...
  describe("Table formatting error handling", () => {
    it("should handle table formatting errors", () => {
      ...
      // Mock formatMessage to throw error
  ...
  describe("Array table formatting error handling", () => {
    it("should handle array table formatting errors", () => {
      ...
      // Mock safeStringify to throw error
  ...
  describe("Table printing error handling", () => {
    ...
    it("should handle table header printing errors", () => {
      const logger = new Logger({
        environment: "development",
        enableJSON: false,
        enableColors: false,
      ...
      // Mock console.log to throw error in header printing
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        "[LOGHORN ERROR] Header printing failed:",
        expect.any(Error)
      );
    ...
    it("should handle table row printing errors", () => {
      const logger = new Logger({
        environment: "development",
        enableJSON: false,
        enableColors: false,
      ...
      logger.table("Test Table", [{ name: "test1" }, { name: "test2" }], {
        format: "custom",
      });
